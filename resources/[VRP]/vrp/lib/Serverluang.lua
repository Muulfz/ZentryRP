...
-- Serverlang object methods

-- load a dict table to the serverlang dict
...
-- load a dict table to the serverlang dict for a specific locale
function Serverlang:loadLocale(locale, dict)
  self:load({[locale] = dict})
end

-- construct Serverlang object
