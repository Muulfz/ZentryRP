...
function tvRP.lockpickVehicle(wait,any)
    ...
    if DoesEntityExist(vehicleHandle) then
        if GetVehicleDoorsLockedForPlayer(vehicleHandle,PlayerId()) or any then
            ...
            vRP.notify("SUCESSO") -- lang.lockpick.success()
            ...
            vRP.notify("DESBLOQUEADO") -- lang.lockpick.unlocked()
        end
    else
        vRP.notify("MUITO LONGE") -- lang.lockpick.toofar()
    end
end
