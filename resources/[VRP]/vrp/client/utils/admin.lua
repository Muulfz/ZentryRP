...
function tvRP.spawnVehicle(model)
    ...
    if HasModelLoaded(mhash) then
        ...
        tvRP.notify(lang.common.invalid_model) -- lang.spawnveh.invalid()
    end
end
...
function tvRP.showSprites()
    ...
    if showsprite then
        tvRP.notify(lang.sprite.on) -- lang.sprites.on()
    else
        tvRP.notify(lang.sprite.off) -- lang.sprites.off()
    end
end
