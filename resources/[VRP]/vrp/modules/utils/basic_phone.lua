                ...
                if target ~= nil then
                    ...
                    if ok then
                        ...
                        if target_bank>0 then
                            ...
                            --vRP.logInfoToFile(lang.mcharge.file(),lang.mcharge.log({user_id,target_id,charge,my_bank,target_bank})
        ...
        if target_id~=nil then
            if my_bank >= 0 then
                ...
                if target ~= nil then
                    ...
                    vRP.setBankMoney(target_id,target_bank)
                    --vRP.logInfoToFile(lang.mpay.file(),lang.mpay.log({user_id,target_id,transfer,my_bank,target_bank})
                    local identity = vRP.getUserIdentity(user_id)
                    local my_directory_name = vRP.getPhoneDirectoryName(target_id, identity.phone)
                    if my_directory_name == "unknown" then
                        my_directory_name = identity.phone
