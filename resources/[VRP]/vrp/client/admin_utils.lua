...
function tvRP.spawnVehicle(model)
    ...
    if HasModelLoaded(mhash) then
        ...
        tvRP.notify("SPAWN SUCESSO") -- lang.spawnveh.success()
    else
        tvRP.notify("ESSA PORRA TA INVALIDA") -- lang.spawnveh.invalid()
    end
end
...
function tvRP.deleteVehicleInFrontOrInside(offset)
    ...
    if IsEntityAVehicle(veh) then
        ...
        tvRP.notify("ESSA PORRA FUNCIONOU") -- lang.deleteveh.success()
    else
        tvRP.notify("ESSA PORRA TA MUITO LONGE") -- lang.deleteveh.toofar()
    end
end
...
function tvRP.deleteNearestVehicle(radius)
    ...
    if IsEntityAVehicle(veh) then
        ...
        tvRP.notify("ESSA PORRA TA LONGE") -- lang.deleteveh.toofar()
    end
end
...
function tvRP.showBlips()
    ...
    if showblip then
        showsprite = true
        tvRP.notify("BLIPS LIGADOS") -- lang.blips.on()
    else
        showsprite = false
        tvRP.notify("BLIPS DESLIGADOS") -- lang.blips.off()
    end
end
...
function tvRP.showSprites()
    ...
    if showsprite then
        tvRP.notify("SPRITES LIGADOS") -- lang.sprites.on()
    else
        tvRP.notify("SPRITES DESLIGADOS") -- lang.sprites.off()
    end
end
