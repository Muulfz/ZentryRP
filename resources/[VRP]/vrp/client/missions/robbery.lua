...
--- Created by Muulfz.
--- DateTime: 8/8/2018 14:38
---
local cfg = module("cfg/missions/robbery")
local lang = module("cfg/lang/missions/robbery/"..cfg.lang)
local robb = ""
local timer = 0
local robbing = false
